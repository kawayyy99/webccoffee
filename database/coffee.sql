...
--
-- Host: 127.0.0.1
-- Generation Time: 02 Agu 2022 pada 12.15
-- Versi Server: 5.6.24
-- PHP Version: 5.6.8
...
(1, 47, 4, 8902, 1, 40000, 'wayan', '12/04/2022'),
(2, 48, 4, 8902, 1, 40000, 'wayan', '12/04/2022');
...
--
ALTER TABLE `tb_order`
  MODIFY `id_order` int(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=49;
--
